import { IconButton, Paper, Table, TableBody, TableCell, TableHead, TableRow, Tooltip, Typography, Box } from '@mui/material'
  ...
  return (
    ...
    >
      <Paper sx={{ p: 2.5 }} data-testid="home-recent-orders-table-card">
        ...
        <Table size="small" data-testid="home-recent-orders-table">
      ...
      <Paper sx={{ p: 2.5 }} data-testid="home-top-customers-table-card">
        ...
        <Table size="small" data-testid="home-top-customers-table">
