export const ordersUiText = {
  ...
  createPage: {
    title: 'Create Order',
    subtitle: 'Select customer and product variants before creating the order.',
    backToOrders: 'Orders',
    sections: {
      customer: 'Customer',
      products: 'Products',
    ...
    actions: {
      addVariant: 'Add Selected Variants',
      create: 'Create Order',
      cancel: 'Cancel',
    },
    placeholders: {
      customerSearch: 'Search by name or email',
      productSearch: 'Search by name or manufacturer',
      noParentProducts: 'No products found.',
      noVariants: 'No active variants available for the selected product.',
      noParentSelected: 'Select a parent product to view variants.',
      noSelectedProducts: 'No products added yet.',
      noDeliveryAddress: 'Select a customer to preview delivery address.',
    },
    labels: {
      customer: 'Customer',
  ...
  dialogs: {
    ...
    createOrderCustomerPlaceholder: 'Select customer',
    ...
    createPageLeaveMessage: 'You have unsaved changes. Do you want to leave this page?',
  },
  toasts: {
  ...
  validation: {
    ...
    deliveryApartmentInvalid: 'Apartment number should be in range 1-9999',
    deliveryZipCodeInvalid: 'Zip Code must match 12345 or 12345-6789',
    deliveryStateInvalid: 'State must be selected',
  },
} as const
